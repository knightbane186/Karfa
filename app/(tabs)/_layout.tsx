...
const CustomHeader = ({ onSearch, showParameters, setShowParameters }) => {
...
const TabsLayout = () => {
  ...
  return (
    <View style={styles.container}>
      {showHeader && (
        <CustomHeader onSearch={handleSearch} showParameters={showParameters} setShowParameters={setShowParameters} />
      )}
